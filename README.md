...
- **자동 검사** — 입력창에 한글을 치고 잠시 멈추면(약 0.9초) 자동으로 검사 (팝업에서 켜고 끌 수 있음)
...
1. [**최신 버전 다운로드**](https://github.com/enbraining/checkcheck/releases/latest/download/checkcheck.zip)
   를 눌러 `checkcheck.zip`을 받고 압축을 풉니다.
